...
const SmartScore = () => {
  ...
  // Filter jobs based on search term and filter - only show active jobs with 50%+ smart score
  const filteredJobs = jobs.filter(job => {
    ...
    // Only show jobs with 50%+ smart score
    const meetsMinimumScore = percentage >= 50;
    
    // Only show active jobs (assuming status field exists, or you can check other active indicators)
    const isActive = job.status === 'active' || job.status === 'open' || !job.status; // Default to active if no status
    
    const matchesFilter = 
      selectedFilter === 'all' ||
      (selectedFilter === 'high' && percentage >= 80) ||
      (selectedFilter === 'good' && percentage >= 70 && percentage < 80) ||
      (selectedFilter === 'medium' && percentage >= 50 && percentage < 70);

    return matchesSearch && matchesFilter && meetsMinimumScore && isActive;
  });
            ...
            <div className="flex-1">
              <div className="flex items-center space-x-4 mb-4">
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-2 mt-1">
                    ...
                    <span className="text-sm font-medium text-blue-600">AI-Powered Matching</span>
                  </div>
                </div>
              </div>
              <p className="text-gray-600 text-lg max-w-2xl leading-relaxed">
                Discover high-potential job matches with AI-driven compatibility scoring based on your skills and experience
              </p>
              ...
              <div className="flex items-center space-x-6 mt-6">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm text-gray-600">50%+ Compatible</span>
                </div>
                <div className="flex items-center space-x-2">
            ...
            <div className="hidden lg:block">
              <div className="bg-white/80 backdrop-blur-sm border border-gray-200/50 rounded-2xl p-6 shadow-lg">
                <div className="text-center">
                  ...
                  <p className="text-sm font-medium text-gray-600">Quality Matches</p>
                  <div className="mt-2 px-3 py-1 bg-gradient-to-r from-green-100 to-blue-100 rounded-full">
                    <span className="text-xs font-medium text-green-700">50%+ Score</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 mb-8">
          <div className="flex flex-col md:flex-row gap-4 items-center">
            ...
            <div className="flex items-center space-x-2">
              ...
              >
                <option value="all">All Quality Matches (50%+)</option>
                <option value="high">Excellent Match (80%+)</option>
                <option value="good">Good Match (70-79%)</option>
                <option value="medium">Fair Match (50-69%)</option>
              </select>
            </div>
          </div>
        </div>
        ...
        {filteredJobs.length === 0 ? (
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-12 text-center">
            ...
            <h3 className="text-xl font-medium text-gray-900 mb-2">No quality matches found</h3>
            <p className="text-gray-600">We couldn't find any active jobs with 50%+ compatibility score. Try updating your profile to improve matches.</p>
          </div>
        ) : (
          <>
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {job.requirements && (
                            <p className="text-gray-600 text-sm leading-relaxed">
                              {truncateRequirementsText(job.requirements, 200)}
                            </p>
                          )}
                        </div>
